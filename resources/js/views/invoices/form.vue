<template>
    <div class="panel" v-if="show">
        ...
        <div class="panel-footer flex-end">
            <div>
                <button class="btn btn-primary" :disabled="isProcessing" @click="onSave">Save <i class="fas fa-save"></i></button>
                <button class="btn" :disabled="isProcessing" @click="onCancel">Cancel <i class="fas fa-window-close red"></i></button>
            </div>
        </div>
    </div>
</template>
