<template>
    ...
    <div class="panel" v-if="show">
        <div class="panel-heading">
            ...
            <div>
                <router-link to="/invoices" class="btn">Back <i class="fas fa-arrow-circle-left"></i></router-link>
                <router-link :to="`/invoices/${model.id}/edit`" class="btn">Edit <i class="fas fa-edit"></i></router-link>
                  <button class="btn btn-primary hidden-print" @click.prevent="printMe">Print <i class="fas fa-print"></i></button>
                <button class="btn btn-error" @click="deleteItem">Delete <i class="fas fa-trash-alt"></i></button>
            </div>
        </div>
