...
class RequestController extends Controller
{
    public function index(Request $request)
    {
        if ($request->query('search')) {
            ...
            $item_reqest = ItemRequest::orderBy('id', 'ASC')->paginate(10);
        }
    ...
    {
        $item_reqest = ItemRequest::with('item', 'user', 'status')->whereItem_id($id)->whereRaw('quantity_requested > quantity_issued')->get();
